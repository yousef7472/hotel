            ...
            <form onSubmit={formSubmit}>
              <div className='grid1'>
                <div className='input'>
                  ...
                  <input type='text' required name='fname' value={fname} onChange={(e) => setFname(e.target.value)} />
                </div>
                <div className='input'>
                  <span>
                    Last Name <label>*</label>
                  </span>
                  <input type='text' required name='lname' value={lname} onChange={(e) => setLname(e.target.value)} />
                </div>
                <div className='input'>
                  <span>
                    Phone Number <label>*</label>
                  </span>
                  <input type='number' required name='phone' value={phone} onChange={(e) => setPhone(e.target.value)} />
                </div>
                <div className='input'>
                  <span>
                    Email <label>*</label>
              ...
              <button className='primary-btn'  aria-label="submit button">Submit Now</button>
            </form>
          </div>
